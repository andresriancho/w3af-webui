...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ScanTask.start'
        db.delete_column(u'scan_tasks', 'start')

        # Adding field 'ScanTask.run_at'
        db.add_column(u'scan_tasks', 'run_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Adding field 'ScanTask.start'
        db.add_column(u'scan_tasks', 'start', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'ScanTask.run_at'
        db.delete_column(u'scan_tasks', 'run_at')
    ...
    models = {
        ...
        'w3af_webui.scan': {
            ...
            'show_report_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 5, 16, 34, 55, 742795)'}),
