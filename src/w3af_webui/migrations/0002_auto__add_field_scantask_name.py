...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScanTask.name'
        db.add_column(u'scan_tasks', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True), keep_default=False)
    ...
    models = {
        ...
        'w3af_webui.scan': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 22, 10, 9, 37, 484164)'}),
