...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scan.user'
        db.add_column(u'scans', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'Scan.user'
        db.delete_column(u'scans', 'user_id')
    ...
    models = {
        ...
        'w3af_webui.scan': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 22, 15, 8, 5, 12086)'}),
